...
public interface ExtConfig {
	...
	/**
	 * <pre>
	 * JobClient,JobTracker,TaskTracker端: 远程通讯请求处理线程数量,
	 * 默认 32 + AVAILABLE_PROCESSOR * 5
	 * </pre>
	 */
	...
	/**
	 * JobClient,JobTracker,TaskTracker端: 远程通讯序列化方式, 可选值 fastjson, hessian2, java,
	 * 默认fastjson
	 */
	String REMOTING_SERIALIZABLE_DFT = "lts.remoting.serializable.default";
	/**
	 * JobClient,TaskTracker端: FailStore,可选值 leveldb, berkeleydb,rocksdb ,mapdb 默认
	 * leveldb
	 */
