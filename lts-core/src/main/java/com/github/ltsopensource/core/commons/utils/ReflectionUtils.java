...
public class ReflectionUtils {
	...
	public static Field[] findFields(Class<?> clazz) throws IllegalAccessException {
		...
		doWithDeclaredFields(clazz, fieldList::add);
	...
	private static void doWithDeclaredFields(Class<?> clazz, FieldCallback fieldCallback)
	...
	public static Method[] findMethods(Class<?> clazz) throws IllegalAccessException {
		...
		doWithDeclaredMethods(clazz, methodList::add);
	...
	private static void doWithDeclaredMethods(Class<?> clazz, MethodCallback methodCallback)
			throws IllegalAccessException {
